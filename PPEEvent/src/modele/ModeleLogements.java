...
public class ModeleLogements {
	    ...
	    public static void UpdateLogements(Logements unLogement) {
	        String requete = "UPDATE logements SET"
            		...
            		+ " logement_type = '" + unLogement.getlogement_type() + "',"
    				+ " logement_lieu = '" + unLogement.getlogement_lieu() + "',"
					+ " logement_adresse = '" + unLogement.getlogement_adresse() + "',"
					+ " logement_nb_etoiles = '" + unLogement.getlogement_nb_etoiles() + "',"
					+ " logement_nb_notes = '" + unLogement.getlogement_nb_notes() + "',"
					+ " logement_description = '" + unLogement.getlogement_description() + "',"
					+ " logement_date_debut = '" + unLogement.getlogement_date_debut() + "',"
					+ " logement_date_fin = '" + unLogement.getlogement_date_fin() + "',"
	        ...
	        try {
	            ...
	            while (desResultats.next()) {
	            	Logements unLogement = new Logements(desResultats.getInt("logement_id"),
	                        ...
	                        desResultats.getString("logement_lieu"),
	                        desResultats.getString("logement_adresse"),
	                        desResultats.getString("logement_nb_etoiles"),
	                        desResultats.getString("logement_nb_notes"),
	                        desResultats.getString("logement_description"),
	        ...
	        try {
	            ...
	            if (unResultat.next()) {
	            	unLogement = new Logements(unResultat.getInt("logements_id"),
	                        ...
	                        unResultat.getString("logement_lieu"),
	                        unResultat.getString("logement_adresse"),
	                        unResultat.getString("logement_nb_etoiles"),
	                        unResultat.getString("logement_nb_notes"),
	                        unResultat.getString("logement_description"),
